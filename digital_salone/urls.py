...
urlpatterns = [
    ...
    path("salon_views/", salonviews.salon_views, name="salon_views"),
    ...
    path("admins_salon_rating_display/", adminsviews.admins_salon_rating_display,
         name="admins_salon_rating_display"),
